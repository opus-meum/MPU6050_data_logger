...
typedef enum
{
	MPU6050_SMPLRT_50_NF          = 0x9F,
    MPU6050_SMPLRT_100_NF         = 0x4F,
	MPU6050_SMPLRT_200_NF         = 0x27,
    MPU6050_SMPLRT_500_NF         = 0x0F,
    MPU6050_SMPLRT_1000_NF        = 0x07,
    MPU6050_SMPLRT_200_F          = 0x04,
	MPU6050_SMPLRT_100_F		  = 0x09
...
class MPU6050
{
	...
	IntVector readRawGyro(void);
	Vector readNormalizeGyro(void);

	IntVector readRawAccel(void);
